...
module.exports = {
    commands: ['buyethereal', 'buy ethereal', 'buy Ethereal' ], // You Can Keep Any Name
 ...
 // You Can Keep Any Name
            ...
            const amount = 270000 // Amount Of Laptop: $10,000
            ...
            if(bal <amount) { // If Balance In Wallet Is Less Then Amount Of Laptop
                return message.reply(`You don't have enough money(\`$270,000\`) in wallet to buy role`)
            } else {
              
                message.member.roles.add('1013446757176320040');
                ...
                .setColor('RANDOM')
                .setDescription(`
<@${user.id}> Successfully purchased role ethereal for \`$270,000\` 👍
                `)
                .setFooter('Shop')
