...
module.exports = {
    commands: ['butdiva', 'buy diva', 'buy Diva' ], // You Can Keep Any Name
 ...
 // You Can Keep Any Name
            ...
            if(bal <amount) { // If Balance In Wallet Is Less Then Amount Of Laptop
                ...
                message.member.roles.add('1013418434643628156');
                ...
                .setColor('RANDOM')
                .setDescription(`
<@${user.id}> Successfully purchased role diva for \`$45,000\` 👍
                `)
                .setFooter('Shop')
                message.channel.send(embed)
                db.add(`bitchtamer${user.id}`, 1) // Add 1 Laptop To User
