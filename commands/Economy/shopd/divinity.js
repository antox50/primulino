...
module.exports = {
    commands: ['buysuperior', 'buy superior', 'buy Superior' ], // You Can Keep Any Name
 ...
 // You Can Keep Any Name
            ...
            const amount = 65000 // Amount Of Laptop: $10,000
            ...
            if(bal <amount) { // If Balance In Wallet Is Less Then Amount Of Laptop
                return message.reply(`You don't have enough money(\`$65,000\`) in wallet to buy role`)
            } else {
              
                message.member.roles.add('1013444899066085376');
                ...
                .setColor('RANDOM')
                .setDescription(`
<@${user.id}> Successfully purchased role superior for \`$65,000\` 👍
                `)
                .setFooter('Shop')
                message.channel.send(embed)
                db.add(`divinity${user.id}`, 1) // Add 1 Laptop To User
