...
module.exports = {
    commands: ['buyheavenly', 'buy heavenly', 'buy Heavenly' ], // You Can Keep Any Name
 ...
 // You Can Keep Any Name
            ...
            const amount = 120000 // Amount Of Laptop: $10,000
            ...
            if(bal <amount) { // If Balance In Wallet Is Less Then Amount Of Laptop
                return message.reply(`You don't have enough money(\`$120,000\`) in wallet to buy role`)
            } else {
              
                message.member.roles.add('1013446216572477440');
                ...
                .setColor('RANDOM')
                .setDescription(`
<@${user.id}> Successfully purchased role heavenly for \`$120,000\` 👍
                `)
                .setFooter('Shop')
                message.channel.send(embed)
                db.add(`huntress${user.id}`, 1) // Add 1 Laptop To User
