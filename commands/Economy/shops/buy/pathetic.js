...
module.exports = {
    commands: ['buybrat', 'buy brat', 'buy Brat'], // You Can Keep Any Name
 ...
 // You Can Keep Any Name
            ...
            const amount = 13000 // Amount Of Laptop: $10,000
            ...
            if(bal <amount) { // If Balance In Wallet Is Less Then Amount Of Laptop
                return message.reply(`You don't have enough money(\`$13,000\`) in wallet to buy role`)
            } else {
              
                message.member.roles.add('1013402407318851635');
                ...
                .setColor('RANDOM')
                .setDescription(`
<@${user.id}> Successfully purchased role brat for \`$13,000\` 👍
                `)
                .setFooter('Shop')
                message.channel.send(embed)
                db.add(`pathetic${user.id}`, 1) // Add 1 Laptop To User
