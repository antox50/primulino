...
module.exports = {
    commands: ['buyfoot-rest', 'buy foorest', 'buy Foot-rest'], // You Can Keep Any Name
 ...
 // You Can Keep Any Name
            ...
            const amount = 45000 // Amount Of Laptop: $10,000
            ...
            if(bal <amount) { // If Balance In Wallet Is Less Then Amount Of Laptop
                return message.reply(`You don't have enough money(\`$45,000\`) in wallet to buy role`)
            } else {
              
                message.member.roles.add('1013403944162172929');
                ...
                .setColor('RANDOM')
                .setDescription(`
<@${user.id}> Successfully purchased role foot-rest for \`$45,000\` 👍
                `)
                .setFooter('Shop')
                message.channel.send(embed)
                db.add(`puppet${user.id}`, 1) // Add 1 Laptop To User
