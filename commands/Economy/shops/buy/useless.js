...
module.exports = {
    commands: ['butpitiful', 'buy pitiful', 'buy Pitiful'], // You Can Keep Any Name
 ...
 // You Can Keep Any Name
            ...
            const amount = 84000 // Amount Of Laptop: $10,000
            ...
            if(bal <amount) { // If Balance In Wallet Is Less Then Amount Of Laptop
                return message.reply(`You don't have enough money(\`$84,000\`) in wallet to buy role`)
            } else {
              
                message.member.roles.add('1013404471973388379');
                ...
                .setColor('RANDOM')
                .setDescription(`
<@${user.id}> Successfully purchased role pitiful for \`$84,000\` 👍
                `)
                .setFooter('Shop')
                message.channel.send(embed)
                db.add(`useless${user.id}`, 1) // Add 1 Laptop To User
